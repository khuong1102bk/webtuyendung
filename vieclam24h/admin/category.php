                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Danh sách ngành nghề</h3>
                                <a class="btn btn-primary float-right" href="category_add.php">Thêm mới</a>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="btn-group">
                                                            <a href="category_edit.php?edit=<?php echo $row['id']; ?>" class="btn btn-success"><i class="fas fa-pencil-alt"></i></a>
                                                            <a onclick="return confirm('Xóa hàng này?')" href="category_delete.php?del=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                                                        </div>
                                                    </div>
