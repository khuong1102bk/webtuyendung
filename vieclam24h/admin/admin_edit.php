...
if (isset($_POST['submit'])) {
  ...
  $query = mysqli_query($conn, "update admin_users set admin_email='$email',admin_pass='$password',
        first_name='$first_name',last_name='$last_name',admin_type='$admin_type' where id='$id'");

  if ($query) {
    echo '<script>alert("Chỉnh sửa hoàn tất!");window.location.href="admin.php";</script>';
  } else {
