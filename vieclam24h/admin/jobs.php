                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="btn btn-primary float-right" href="jobs_add.php">Thêm mới</a>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo substr($row['job_des'], 0, 25) ?>...</td>
                                                <td>
                                                    <div class="row">
                                                        <div class="btn-group">
                                                            <a href="jobs_edit.php?edit=<?php echo $row['job_id']; ?>" class="btn btn-success"><i class="fas fa-pencil-alt"></i></a>
                                                            <a onclick="return confirm('Xóa hàng này?')" href="jobs_delete.php?del=<?php echo $row['job_id']; ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
