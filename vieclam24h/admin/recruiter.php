                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="btn btn-primary float-right" href="recruiter_add.php">Thêm mới</a>
                            ...
                            <div class="card-body">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $query = mysqli_query($conn, "select * from recruiter");
                                        $i = 0;
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="btn-group">
                                                            <a href="recruiter_edit.php?edit=<?php echo $row['id']; ?>" class="btn btn-success"><i class="fas fa-pencil-alt"></i></a>
                                                            <a onclick="return confirm('Xóa hàng này?')" href="recruiter_delete.php?del=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                                                        </div>
                                                    </div>
