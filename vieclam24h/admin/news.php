                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="btn btn-primary float-right" href="news_add.php">Thêm mới</a>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="btn-group">
                                                            <a href="news_edit.php?edit=<?php echo $row['id']; ?>" class="btn btn-success"><i class="fas fa-pencil-alt"></i></a>
                                                            <a onclick="return confirm('Xóa hàng này?')" href="news_delete.php?del=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                                                        </div>
                                                    </div>
