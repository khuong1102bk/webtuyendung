        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Thên mới</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Thêm ngành nghề mới</h3>
              ...
              <div class="card-body">
                <form action="" method="POST" style="margin-left: 20%; margin-right: 20%;" name="category_form" id="category_form">
                  <div class="form-group">
                    ...
                    <input required type="text" name="category" id="category" class="form-control" placeholder="Nhập tên ngành nghề *">
                  </div>
