...
<head>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="admin.php">Quản lý nhân viên</a></li>
              ...
              <div class="card-body">
                <form action="" method="POST" style="margin-left: 20%; margin-right: 20%;" name="customer_form" id="customer_form">
                  ...
                  <div class="form-group">
                    ...
                    <select required name="admin_type" class="form-control" id="admin_type">
                      <option disable selected hidden value=""> Choose Role *</option>
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($conn, "insert into admin_users(admin_email,admin_pass,first_name,last_name,admin_type)
  values('$email','$password','$first_name','$last_name','$admin_type')");
