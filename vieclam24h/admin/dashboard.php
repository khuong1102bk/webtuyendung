...
<head>
    ...
    <title>Admin Vieclam24h | Dashboard</title>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="logout.php"><?php echo $_SESSION['email']; ?> | Đăng xuất</a>
                    </a>
                </li>
            </ul>
        </nav>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2021 <a href="#">ViecLam24h</a>.</strong>
            All rights reserved.
